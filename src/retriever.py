...
def query_faiss(
    query: str,
    top_k: int = 10,                  # Recommended for augmented corpora
    model_name: str = "all-MiniLM-L6-v2",
    dedup_by_source: bool = True,
    overretrieve_factor: int = 4      # 3–5× is a good starting range
):
    """
